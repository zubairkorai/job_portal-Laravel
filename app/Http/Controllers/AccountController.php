...
class AccountController extends Controller
{
    ...
    public function processForgotPassword(Request $request){
        ...
        return redirect()->route('account.forgotPassword')->with('success','Reset password email hasbeen sent to you.');
    ...
    public function processResetPassword(Request $request){
        ...
        return redirect()->route('account.login')->with('success','You can login now!!');
